...
After every HTML generation (Phase B → Fragment Master Mode), a full regression cycle MUST be performed. This phase is **blocking** — the HTML delivery is not considered complete until regression passes.
